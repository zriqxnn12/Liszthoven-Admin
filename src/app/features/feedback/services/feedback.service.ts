...
export class FeedbackService {
  ...
  getFeedbacks(dataListParameter: DataListParameter = {} as DataListParameter) {
    let param = '';
    ...
    return this.http.get(`${ROOT_API}/admin/feedbacks${param}`);
  }

  getFeedback(id: number) {
    return this.http.get(`${ROOT_API}/admin/feedbacks/${id}`);
  }
}
